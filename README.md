# 💊 Affordable Drug Alternatives: A Comparative Analysis

A summary comparing originator drugs with their lower-cost alternatives for key medical conditions.

## Static Chemical Similarity Demo

This repository also includes a static GitHub Pages demo for preprocessed compound similarity exploration:

- Frontend source: `Changjin/frontend/`
- Static data: `Changjin/frontend/public/data/`
- Deployment: GitHub Actions builds `Changjin/frontend/dist`
- Published URL: `https://cccccjin.github.io/Affordable-Drug-Alternatives/`
